...
internal fun AnalyticsLogger.logPokemonDetail(
    pokemonId: String,
    name: String,
) {
...
internal fun AnalyticsLogger.logBiomeDetail(
    biomeId: String,
    name: String,
) {
...
internal fun AnalyticsLogger.logBattlePokemon(
    pokemonId: String,
    name: String,
) {
...
internal fun AnalyticsLogger.logAbilityDetail(
    abilityId: String,
    name: String,
) {
