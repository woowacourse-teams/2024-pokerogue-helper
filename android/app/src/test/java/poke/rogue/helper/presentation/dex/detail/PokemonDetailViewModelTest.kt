...
import poke.rogue.helper.presentation.dex.model.MoveCategoryUiModel
                    ...
                    moves =
                        listOf(
                            PokemonMoveUiModel(
                                ...
                                accuracy = 100,
                                category = MoveCategoryUiModel(1, "물리", R.drawable.ic_physical_attack_move),
                            ),
                            PokemonMoveUiModel(
                                id = 2,
                                name = "울음소리",
                                level = 1,
                                power = PokemonMoveUiModel.NO_POWER,
                                type = TypeUiModel.NORMAL,
                                accuracy = 100,
                                category = MoveCategoryUiModel(3, "변화", R.drawable.ic_change_status_move),
                            ),
                            PokemonMoveUiModel(
                                id = 3,
                                name = "덩굴채찍",
                            ...
                            PokemonMoveUiModel(
                                ...
                                type = TypeUiModel.GRASS,
                                accuracy = 95,
                                MoveCategoryUiModel(1, "물리", R.drawable.ic_physical_attack_move),
                            ),
                            PokemonMoveUiModel(
                                id = 7,
                                name = "독가루",
                            ...
                            PokemonMoveUiModel(
                                ...
                                type = TypeUiModel.GRASS,
                                accuracy = 100,
                                category = MoveCategoryUiModel(2, "특수", R.drawable.ic_special_attack_move),
                            ),
                        ),
                    height = 0.7f,
                    weight = 6.9f,
