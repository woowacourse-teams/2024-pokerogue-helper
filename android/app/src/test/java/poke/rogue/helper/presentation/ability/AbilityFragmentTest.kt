...
import poke.rogue.helper.presentation.ability.AbilityFragment
...
class AbilityFragmentTest {
    ...
    fun `Fragment 실행 테스트`() {
        val scenario =
            launchFragmentInContainer<AbilityFragment>(themeResId = R.style.Theme_PokeRogueHelper)
