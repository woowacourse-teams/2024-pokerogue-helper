...
class TypeMultiplierProviderTest extends ServiceTest {
    ...
    void getByTypeMatching() {
        Pokemon rivalPokemon = pokemonMongoRepository.findByIndexAndLanguage("squirtle", "en").get();
    ...
    void getByStrongWind() {
        Pokemon rivalPokemon = pokemonMongoRepository.findByIndexAndLanguage("pidgey", "en").get();
        List<Type> rivalPokemonTypes = rivalPokemon.getTypes();
