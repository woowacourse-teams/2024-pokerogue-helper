...
class BiomeDatabaseInitializerTest {
    ...
    void setBiomesData() {
        ...
        BiomePokemonInfoRepository biomePokemonInfoRepository = new BiomePokemonInfoRepository();
        BiomeDatabaseInitializer biomeDatabaseInitializer = new BiomeDatabaseInitializer(
                biomeRepository,
                biomePokemonInfoRepository
        );
