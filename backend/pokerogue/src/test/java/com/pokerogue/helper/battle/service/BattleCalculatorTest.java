...
class BattleCalculatorTest extends ServiceTest {
    ...
    void calculateAccuracy() {
        Move move = moveRepository.findById("ember").get();
    ...
    void calculateBattleResult() {
        ...
        Pokemon rivalPokemon = pokemonRepository.findById("bulbasaur").get();
        Pokemon myPokemon = pokemonRepository.findById("charmander").get();
